...
type Settings struct {
	...
	ThemeAuto                   bool   `json:"theme_auto"`
	ThemeMode                   string `json:"theme_mode"`
	ThemeLightVariant           string `json:"theme_light_variant"`
	ThemeDarkVariant            string `json:"theme_dark_variant"`
	...
	AiSystemPromptCustomEnabled bool   `json:"ai_system_prompt_custom_enabled"`
	AiSystemPromptCustom        string `json:"ai_system_prompt_custom"`
}
...
func (s Settings) Map() map[string]any {
	return map[string]any{
		...
		"theme_auto":                      s.ThemeAuto,
		"theme_mode":                      s.ThemeMode,
		"theme_light_variant":             s.ThemeLightVariant,
		"theme_dark_variant":              s.ThemeDarkVariant,
		...
		"ai_model":                        s.AiModel,
		"ai_system_prompt_custom_enabled": s.AiSystemPromptCustomEnabled,
		"ai_system_prompt_custom":         s.AiSystemPromptCustom,
	}
}
...
func SettingsDefault() Settings {
	return Settings{
		...
		ThemeAuto:                   false,
		ThemeMode:                   "",
		ThemeLightVariant:           "white",
		ThemeDarkVariant:            "black",
		ThemeAccent:                 "blue",
		RefreshRate:                 0,
		Language:                    "en",
		AiEndpoint:                  "",
		AiApiKey:                    "",
		AiModel:                     "",
		AiSystemPromptCustomEnabled: false,
		AiSystemPromptCustom:        "",
	}
}
